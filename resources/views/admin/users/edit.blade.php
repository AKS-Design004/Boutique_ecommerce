                ...
                <div class="p-8 bg-gradient-to-r from-white to-purple-50/30">
                    ...
                    <div class="flex flex-col lg:flex-row lg:items-center justify-between mb-8">
                        <div class="mb-4 lg:mb-0">
                            ...
                            <p class="text-gray-600 text-lg">Modifiez les informations de {{ $user->name }}</p>
                        </div>
                        <a href="{{ route('admin.users.show', $user) }}" class="group inline-flex items-center px-6 py-3 bg-gradient-to-r from-gray-200 to-gray-300 text-gray-700 font-bold rounded-2xl hover:from-gray-300 hover:to-gray-400 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl">
                    ...
                    <div class="bg-gradient-to-br from-gray-50 to-white rounded-2xl shadow-lg border border-gray-100 p-6">
                        <form action="{{ route('admin.users.update', $user) }}" method="POST">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                                <!-- Mot de passe -->
                                <div>
                                    <label for="password" class="block text-sm font-bold text-gray-700 uppercase tracking-wide mb-2">Nouveau mot de passe (optionnel)</label>
                                    <input type="password"
                                           name="password"
                                           id="password"
                                           class="w-full border border-gray-200 rounded-xl px-4 py-3 text-gray-900 focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-300 hover:shadow-md bg-white/50"
                                ...
                                <div>
                                    <label for="password_confirmation" class="block text-sm font-bold text-gray-700 uppercase tracking-wide mb-2">Confirmer le nouveau mot de passe</label>
                                    <input type="password"
                            ...
                            <div class="mb-8">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <label class="relative flex cursor-pointer rounded-2xl border border-gray-200 bg-white/50 p-4 shadow-sm focus:outline-none hover:shadow-md transition-all duration-300 {{ old('role', $user->role) === 'client' ? 'border-purple-500' : '' }}">
                                        ...
                                        <svg class="h-5 w-5 text-purple-500 {{ old('role', $user->role) === 'client' ? 'opacity-100' : 'opacity-0' }}" viewBox="0 0 20 20" fill="currentColor">
                                            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                        </svg>
                                    </label>

                                    <label class="relative flex cursor-pointer rounded-2xl border border-gray-200 bg-white/50 p-4 shadow-sm focus:outline-none hover:shadow-md transition-all duration-300 {{ old('role', $user->role) === 'admin' ? 'border-purple-500' : '' }}">
                                        ...
                                        <svg class="h-5 w-5 text-purple-500 {{ old('role', $user->role) === 'admin' ? 'opacity-100' : 'opacity-0' }}" viewBox="0 0 20 20" fill="currentColor">
                                            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                        </svg>
                                    </label>
                                </div>
                            ...
                            <div class="flex items-center justify-end space-x-4">
                                <a href="{{ route('admin.users.show', $user) }}" class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-gray-200 to-gray-300 text-gray-700 font-bold rounded-2xl hover:from-gray-300 hover:to-gray-400 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl">
                                    Annuler
                                </a>
